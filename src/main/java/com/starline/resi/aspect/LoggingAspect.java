package com.starline.resi.aspect;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.starline.resi.config.LoggingContext;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(@com.starline.resi.annotations.LogRequestResponse * *(..))")
    public void methodWithLoggedRequestResponse() {
    }


    @Pointcut("within(@com.starline.resi.annotations.LogRequestResponse *)")
    public void classWithLogRequestResponse() {
    }

    @Pointcut("within(@com.starline.resi.annotations.LogResponse *)")
